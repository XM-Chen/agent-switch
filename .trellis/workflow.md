...
<!--
  ...
  Editing checklist:
    ...
    - Full runtime contract:
      .trellis/spec/trellis-runtime/workflow-state-contract.md
-->
...
- `.trellis/spec/trellis-runtime/workflow-state-contract.md` — runtime contract + writer table + test invariants
- `.claude/hooks/inject-workflow-state.py`（及其他平台生成的同名 hook）— actual parser (reads workflow.md only, no embedded text)
