...
- Read [Gateway Takeover](gateway-takeover.md) before changing proxy_config migrations, takeover lifecycle, gateway start/stop, route_mode, snapshot recovery, proxy status IPC, external-config detection/conflicts, or managed-write suppression.
