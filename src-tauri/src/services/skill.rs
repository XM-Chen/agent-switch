...
//!
//! v3.10.0+ 统一管理架构：
//! - SSOT（单一事实源）：`~/.agent-switch/skills/`
...
pub enum SkillStorageLocation {
    /// CC Switch 管理目录 (~/.agent-switch/skills/)
    #[default]
    CcSwitch,
...
impl SkillService {
    ...
    /// 获取 SSOT 目录（根据设置返回 ~/.agent-switch/skills/ 或 ~/.agents/skills/）
    ...
    /// 获取 Skill 卸载备份目录（~/.agent-switch/skill-backups/）
